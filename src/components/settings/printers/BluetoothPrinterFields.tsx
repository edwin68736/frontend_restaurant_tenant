    ...
    <div className="rounded-xl border border-stone-200 bg-stone-50/80 p-4 space-y-3">
      <div>
        <p className="text-sm font-semibold text-stone-900 flex items-center gap-2">
          <Bluetooth size={18} className="text-rest-600" />
          Impresión Bluetooth
        </p>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          onClick={() => void onScan()}
          disabled={scanning}
          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-rest-600 text-white text-xs font-semibold hover:bg-rest-700 disabled:opacity-50"
        >
              ...
              <li key={d.address}>
                <button
                  ...
                  className={clsx(
                    ...
                    selected
                      ? 'border-rest-500 bg-rest-50'
                      : 'border-stone-200 bg-white hover:border-rest-300 hover:bg-stone-50',
                  )}
                >
