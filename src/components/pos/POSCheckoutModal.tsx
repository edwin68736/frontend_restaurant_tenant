...
export function POSCheckoutModal({
  ...
  const methodCardClass = (selected: boolean) =>
    clsx(
      'flex min-h-[52px] flex-col items-center justify-center gap-0.5 rounded-xl border p-1.5 transition focus:outline-none focus:ring-2 focus:ring-rest-500/40',
      selected
        ? 'border-rest-500 bg-rest-50 ring-1 ring-rest-500/50'
        : 'border-stone-200 bg-white hover:border-rest-300 hover:bg-stone-50/80',
    )
              ...
              <div className="mb-1.5 flex items-center justify-between gap-2">
                ...
                <label className="inline-flex cursor-pointer select-none items-center gap-1.5 text-[11px] font-medium text-stone-500">
                  <input
                    ...
                    className="h-3.5 w-3.5 rounded border-stone-300 text-rest-600 focus:ring-rest-500/40"
                  />
                  Más opciones
                </label>
              </div>
                ...
                {slotButtons.map((n) => (
                  <button
                    ...
                    className={clsx(
                      ...
                      paymentSlotsCount === n
                        ? 'border-rest-600 bg-rest-600 text-white'
                        : 'border-stone-200 bg-white text-stone-700 hover:border-rest-300 hover:bg-rest-50/50',
                    )}
                  >
                    {n}
                  </button>
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="rounded-xl border border-stone-200 bg-stone-50/80 px-3 py-2.5 space-y-1">
                  ...
                  >
                    ...
                    <span className="text-base font-bold text-rest-600">{formatMoney(payableTotal)}</span>
                  </div>
