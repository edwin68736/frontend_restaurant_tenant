...
import { MOBILE_NAV_BOTTOM_OFFSET, SHELL_SAFE_TOP, SHELL_SAFE_TOP_REST } from '@/utils/safeAreaClasses'
 ...
 * En Android nativo no se muestra (interfiere con safe areas en tablets landscape).
 */
export default function RestaurantLayout() {
  ...
  return (
    <div
      className={clsx(
        'relative flex h-[100dvh] w-full flex-col overflow-hidden bg-stone-50',
    ...
    >
      ...
      <div
        className={clsx(
          ...
          showDesktopTopBar && 'lg:mt-6 lg:rounded-t-3xl lg:shadow-[0_-4px_20px_rgba(15,23,42,0.1)]',
          nativeCapacitor ? SHELL_SAFE_TOP_REST : clsx('bg-stone-50', SHELL_SAFE_TOP),
        )}
      >
        <div className="flex h-full min-h-0 w-full overflow-hidden">
          {sidebarOpen ? (
            <div
              className="fixed inset-x-0 z-[104] bg-stone-900/50 lg:hidden"
              style={{
                top: 'var(--safe-top)',
          ...
          <div
            className={clsx(
              ...
              nativeCapacitor
                ? 'lg:px-2 lg:pt-2 lg:pb-[max(0.5rem,var(--safe-bottom))]'
                : 'lg:p-2',
          ...
          {sidebarOpen ? (
            <div
              className="fixed left-0 z-[105] flex w-[min(80vw,17rem)] min-h-0 flex-col overflow-hidden lg:hidden"
              style={{
                top: 'var(--safe-top)',
                bottom: MOBILE_NAV_BOTTOM_OFFSET,
              }}
          ...
          <div
            className={clsx(
              ...
              mobileFlush
                ? 'gap-0 px-0 pt-0 lg:px-2 lg:pt-2 lg:gap-2'
                : 'gap-2 px-2 pt-2 sm:px-3 lg:px-2 lg:pt-2',
            )}
          >
            <div
              className={clsx(
                'relative z-[100] shrink-0 overflow-visible bg-white',
                fullBleedMobile || mobileFlush
                  ? 'rounded-none border-0 border-b border-stone-100 shadow-none max-lg:rounded-none lg:rounded-2xl lg:border lg:border-stone-100 lg:shadow-md'
            ...
            <main
              className={clsx(
                ...
                fullBleedMobile || mobileFlush
                  ? 'rounded-none border-0 shadow-none max-lg:rounded-none lg:rounded-2xl lg:border lg:border-stone-100 lg:shadow-md'
                  : 'rounded-2xl border border-stone-100 shadow-md',
              )}
            >
              <div
