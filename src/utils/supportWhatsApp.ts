...
/**
 * Normaliza un número guardado sin prefijo internacional (ej. 914561918)
 * a dígitos E.164 sin "+" para wa.me (ej. 51914561918).
 */
...
/** Normaliza número WhatsApp y construye enlace wa.me con mensaje opcional. */
...
/** Mensaje predeterminado al contactar soporte desde el panel restaurante. */
export const DEFAULT_SUPPORT_WHATSAPP_MESSAGE =
  'Hola, necesito ayuda con mi panel de restaurante Tukifac.'

/** Abre URL externa (navegador o WhatsApp) en web y en app de escritorio Tauri. */
export async function openExternalUrl(url: string): Promise<void> {
  ...
  // propio aviso; no vale la pena arriesgar sacar al usuario de la app por eso.
