...
/** Lee vinculación desde almacenamiento nativo (Capacitor / Tauri) — solo producción. */
...
/** Persiste en disco nativo (producción). En desarrollo usa localStorage del WebView. */
