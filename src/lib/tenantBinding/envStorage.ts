...
const DEV_LS_KEY = 'tukichef_tenant_binding_dev_v1'
const PROD_PREFS_KEY = 'tukichef_tenant_binding_v1'
const DEV_PREFS_KEY = 'tukichef_tenant_binding_dev_v1'
...
export function localStorageKeyForEnvironment(env: AppEnvironment = currentBindingEnvironment()): string {
  return env === 'development' ? DEV_LS_KEY : 'tukichef_tenant_binding_prod_v1'
}
