 ...
 *
 * Las cuotas del plan (usuarios, sucursales, productos) llegan por `limits`: tukichef no monta
 * ModulesContext, así que las lee con usePlanLimits.
 */
...
/** Umbral de aviso proactivo, el mismo que usa el ERP. */
