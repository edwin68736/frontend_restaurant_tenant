    ...
    <div className="w-full space-y-4 pb-6">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-stone-500 mt-0.5">Pagos, plan y documentos electrónicos · Tukichef</p>
        </div>
        <button
          type="button"
          onClick={() => {
              ...
              payableInvoices.length === 0 ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4 max-w-xl">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-5 py-2.5 rounded-xl bg-rest-800 text-white text-sm font-semibold hover:bg-rest-700 disabled:opacity-60 flex items-center gap-2"
                  >
